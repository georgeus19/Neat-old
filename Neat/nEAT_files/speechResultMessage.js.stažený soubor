(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = "function" == typeof require && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = "MODULE_NOT_FOUND", a } var p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = "function" == typeof require && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
   1: [function (require, module, exports) {
      ...
      (function (global, Buffer) {
         ...
         goog.DEPENDENCIES_ENABLED && (goog.dependencies_ = { pathIsModule: {}, nameToPath: {}, requires: {}, visited: {}, written: {}, deferred: {} }, goog.inHtmlDocument_ = function () { var a = goog.global.document; return null != a && "write" in a }, goog.findBasePath_ = function () {
         ...
         }, goog.importScript_ = function (a, b) { (goog.global.CLOSURE_IMPORT_SCRIPT || goog.writeScriptTag_)(a, b) && (goog.dependencies_.written[a] = !0) }, goog.IS_OLD_IE_ = !(goog.global.atob || !goog.global.document || !goog.global.document.all), goog.importModule_ = function (a) { goog.importScript_("", 'goog.retrieveAndExecModule_("' + a + '");') && (goog.dependencies_.written[a] = !0) }, goog.queuedModules_ = [], goog.wrapModule_ = function (a, b) {
         ...
         }, goog.isDeferredModule_ = function (a) { return (a = goog.getPathFromDeps_(a)) && goog.dependencies_.pathIsModule[a] ? goog.basePath + a in goog.dependencies_.deferred : !1 }, goog.allDepsAreAvailable_ = function (a) { if ((a = goog.getPathFromDeps_(a)) && a in goog.dependencies_.requires) for (var b in goog.dependencies_.requires[a]) if (!goog.isProvided_(b) && !goog.isDeferredModule_(b)) return !1; return !0 }, goog.maybeProcessDeferredPath_ = function (a) {
            if (a in goog.dependencies_.deferred) {
               var b =
                  goog.dependencies_.deferred[a]; delete goog.dependencies_.deferred[a]; goog.globalEval(b)
            }
         }, goog.loadModuleFromUrl = function (a) { goog.retrieveAndExecModule_(a) }, goog.loadModule = function (a) {
         ...
         }, goog.loadModuleFromSource_ = function (a) { eval(a); return {} }, goog.writeScriptSrcNode_ = function (a) { goog.global.document.write('<script type="text/javascript" src="' + a + '">\x3c/script>') }, goog.appendScriptSrcNode_ = function (a) {
         ...
         }, goog.lastNonModuleScriptIndex_ = 0, goog.onScriptLoad_ = function (a, b) { "complete" == a.readyState && goog.lastNonModuleScriptIndex_ == b && goog.loadQueuedModules_(); return !0 }, goog.writeScripts_ = function (a) {
            function b(a) {
               if (!(a in e.written || a in e.visited)) {
               e.visited[a] = !0; if (a in e.requires) for (var f in e.requires[a]) if (!goog.isProvided_(f)) if (f in
                  e.nameToPath) b(e.nameToPath[f]); else throw Error("Undefined nameToPath for " + f); a in d || (d[a] = !0, c.push(a))
               }
         ...
         }; goog.evalWorksForGlobals_ = null; goog.getCssName = function (a, b) { var c = function (a) { return goog.cssNameMapping_[a] || a }, d = function (a) { a = a.split("-"); for (var b = [], d = 0; d < a.length; d++)b.push(c(a[d])); return b.join("-") }, d = goog.cssNameMapping_ ? "BY_WHOLE" == goog.cssNameMappingStyle_ ? c : d : function (a) { return a }; return b ? a + "-" + d(b) : d(a) };
         ...
         }; goog.scope = function (a) { a.call(goog.global) }; COMPILED || (goog.global.COMPILED = COMPILED);
         ...
         goog.string.compareVersions = function (a, b) {
            for (var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0; 0 == c && g < f; g++) {
               var h = d[g] || "", k = e[g] || "", l = RegExp("(\\d*)(\\D*)", "g"), p = RegExp("(\\d*)(\\D*)", "g"); do {
                  var m = l.exec(h) || ["", "", ""], n = p.exec(k) || ["", "", ""]; if (0 == m[0].length && 0 == n[0].length) break; var c = 0 == m[1].length ? 0 : parseInt(m[1], 10), q = 0 == n[1].length ? 0 : parseInt(n[1], 10), c = goog.string.compareElements_(c, q) || goog.string.compareElements_(0 ==
                     m[2].length, 0 == n[2].length) || goog.string.compareElements_(m[2], n[2])
               } while (0 == c)
            } return c
         }; goog.string.compareElements_ = function (a, b) { return a < b ? -1 : a > b ? 1 : 0 }; goog.string.hashCode = function (a) { for (var b = 0, c = 0; c < a.length; ++c)b = 31 * b + a.charCodeAt(c) >>> 0; return b }; goog.string.uniqueStringCounter_ = 2147483648 * Math.random() | 0; goog.string.createUniqueString = function () { return "goog_" + goog.string.uniqueStringCounter_++ };
         ...
         goog.labs.userAgent.platform.getVersion = function () {
            var a = goog.labs.userAgent.util.getUserAgent(), b = ""; goog.labs.userAgent.platform.isWindows() ? (b = /Windows (?:NT|Phone) ([0-9.]+)/, b = (a = b.exec(a)) ? a[1] : "0.0") : goog.labs.userAgent.platform.isIos() ? (b = /(?:iPhone|iPod|iPad|CPU)\s+OS\s+(\S+)/, b = (a = b.exec(a)) && a[1].replace(/_/g, ".")) : goog.labs.userAgent.platform.isMacintosh() ? (b = /Mac OS X ([0-9_.]+)/, b = (a = b.exec(a)) ? a[1].replace(/_/g, ".") : "10") : goog.labs.userAgent.platform.isAndroid() ? (b = /Android\s+([^\);]+)(\)|;)/,
               b = (a = b.exec(a)) && a[1]) : goog.labs.userAgent.platform.isChromeOS() && (b = /(?:CrOS\s+(?:i686|x86_64)\s+([0-9.]+))/, b = (a = b.exec(a)) && a[1]); return b || ""
         ...
         goog.labs.userAgent.browser.getVersion = function () {
            function a(a) { a = goog.array.find(a, d); return c[a] || "" } var b = goog.labs.userAgent.util.getUserAgent(); if (goog.labs.userAgent.browser.isIE()) return goog.labs.userAgent.browser.getIEVersion_(b); var b = goog.labs.userAgent.util.extractVersionTuples(b), c = {}; goog.array.forEach(b, function (a) { c[a[0]] = a[1] }); var d = goog.partial(goog.object.containsKey, c); return goog.labs.userAgent.browser.isOpera() ? a(["Version", "Opera", "OPR"]) : goog.labs.userAgent.browser.isEdge() ?
         ...
         goog.crypt.base64.init_ = function () {
            if (!goog.crypt.base64.byteToCharMap_) {
               goog.crypt.base64.byteToCharMap_ = {}; goog.crypt.base64.charToByteMap_ = {}; goog.crypt.base64.byteToCharMapWebSafe_ = {}; for (var a = 0; a < goog.crypt.base64.ENCODED_VALS.length; a++)goog.crypt.base64.byteToCharMap_[a] = goog.crypt.base64.ENCODED_VALS.charAt(a), goog.crypt.base64.charToByteMap_[goog.crypt.base64.byteToCharMap_[a]] = a, goog.crypt.base64.byteToCharMapWebSafe_[a] = goog.crypt.base64.ENCODED_VALS_WEBSAFE.charAt(a), a >= goog.crypt.base64.ENCODED_VALS_BASE.length &&
                  (goog.crypt.base64.charToByteMap_[goog.crypt.base64.ENCODED_VALS_WEBSAFE.charAt(a)] = a)
            }
         }; jspb.ExtensionFieldInfo = function (a, b, c, d, e) { this.fieldIndex = a; this.fieldName = b; this.ctor = c; this.toObjectFn = d; this.isRepeated = e }; jspb.ExtensionFieldBinaryInfo = function (a, b, c, d, e, f) { this.fieldInfo = a; this.binaryReaderFn = b; this.binaryWriterFn = c; this.binaryMessageSerializeFn = d; this.binaryMessageDeserializeFn = e; this.isPacked = f }; jspb.ExtensionFieldInfo.prototype.isMessageType = function () { return !!this.ctor }; jspb.Message = function () { }; jspb.Message.GENERATE_TO_OBJECT = !0; jspb.Message.GENERATE_FROM_OBJECT = !goog.DISALLOW_TEST_ONLY_CODE;
         ...
         a.wrappers_ = null; b || (b = c ? [c] : []); a.messageId_ = c ? String(c) : void 0; a.arrayIndexOffset_ = 0 === c ? -1 : 0; a.array = b; jspb.Message.initPivotAndExtensionObject_(a, d); a.convertedFloatingPointFields_ = {}; jspb.Message.SERIALIZE_EMPTY_TRAILING_FIELDS || (a.repeatedFields = e); if (e) for (b = 0; b < e.length; b++)c = e[b], c < a.pivot_ ? (c = jspb.Message.getIndex_(a, c), a.array[c] = a.array[c] || jspb.Message.EMPTY_LIST_SENTINEL_) : (jspb.Message.maybeInitEmptyExtensionObject_(a), a.extensionObject_[c] =
            a.extensionObject_[c] || jspb.Message.EMPTY_LIST_SENTINEL_); if (f && f.length) for (b = 0; b < f.length; b++)jspb.Message.computeOneofCase(a, f[b])
         }; jspb.Message.EMPTY_LIST_SENTINEL_ = goog.DEBUG && Object.freeze ? Object.freeze([]) : []; jspb.Message.isArray_ = function (a) { return jspb.Message.ASSUME_LOCAL_ARRAYS ? a instanceof Array : goog.isArray(a) };
            ...
            if (a == b) return !0; if (!goog.isObject(a) || !goog.isObject(b)) return goog.isNumber(a) && isNaN(a) || goog.isNumber(b) && isNaN(b) ? String(a) == String(b) : !1; if (a.constructor != b.constructor) return !1; if (jspb.Message.SUPPORTS_UINT8ARRAY_ && a.constructor === Uint8Array) { if (a.length != b.length) return !1; for (var c = 0; c < a.length; c++)if (a[c] != b[c]) return !1; return !0 } if (a.constructor === Array) {
               for (var d = void 0, e = void 0, f = Math.max(a.length, b.length), c = 0; c < f; c++) {
                  var g = a[c], h = b[c]; g && g.constructor ==
                     Object && (goog.asserts.assert(void 0 === d), goog.asserts.assert(c === a.length - 1), d = g, g = void 0); h && h.constructor == Object && (goog.asserts.assert(void 0 === e), goog.asserts.assert(c === b.length - 1), e = h, h = void 0); if (!jspb.Message.compareFields(g, h)) return !1
         ...
         jspb.utils.splitFloat32 = function (a) {
            var b = 0 > a ? 1 : 0; a = b ? -a : a; var c; 0 === a ? 0 < 1 / a ? (jspb.utils.split64High = 0, jspb.utils.split64Low = 0) : (jspb.utils.split64High = 0, jspb.utils.split64Low = 2147483648) : isNaN(a) ? (jspb.utils.split64High = 0, jspb.utils.split64Low = 2147483647) : a > jspb.BinaryConstants.FLOAT32_MAX ? (jspb.utils.split64High = 0, jspb.utils.split64Low = (b << 31 | 2139095040) >>> 0) : a < jspb.BinaryConstants.FLOAT32_MIN ? (a = Math.round(a / Math.pow(2, -149)), jspb.utils.split64High = 0, jspb.utils.split64Low = (b << 31 | a) >>> 0) : (c = Math.floor(Math.log(a) /
         ...
         }; jspb.BinaryWriter = function () { this.blocks_ = []; this.totalLength_ = 0; this.encoder_ = new jspb.BinaryEncoder; this.bookmarks_ = [] }; jspb.BinaryWriter.prototype.appendUint8Array_ = function (a) { var b = this.encoder_.end(); this.blocks_.push(b); this.blocks_.push(a); this.totalLength_ += b.length + a.length };
         ...
         jspb.BinaryDecoder.prototype.readSplitVarint64_ = function () {
            for (var a, b = 0, c, d = 0; 4 > d; d++)if (a = this.bytes_[this.cursor_++], b |= (a & 127) << 7 * d, 128 > a) { this.tempLow_ = b >>> 0; this.tempHigh_ = 0; return } a = this.bytes_[this.cursor_++]; b |= (a & 127) << 28; c = 0 | (a & 127) >> 4; if (128 > a) this.tempLow_ = b >>> 0, this.tempHigh_ = c >>> 0; else {
               for (d = 0; 5 > d; d++)if (a = this.bytes_[this.cursor_++], c |= (a & 127) << 7 * d + 3, 128 > a) { this.tempLow_ = b >>> 0; this.tempHigh_ = c >>> 0; return } goog.asserts.fail("Failed to read varint, encoding is invalid."); this.error_ =
                  !0
            }
         }; jspb.BinaryDecoder.prototype.skipVarint = function () { for (; this.bytes_[this.cursor_] & 128;)this.cursor_++; this.cursor_++ }; jspb.BinaryDecoder.prototype.unskipVarint = function (a) { for (; 128 < a;)this.cursor_-- , a >>>= 7; this.cursor_-- };
      ...
      var speechResultMessage = require("./speechResultMessage_pb");

      module.exports = {
         DataProto: speechResultMessage
      };
   }, { "./speechResultMessage_pb": 6 }], 6: [function (require, module, exports) {
      /**
       * @fileoverview
       * @enhanceable
      ...
      goog.exportSymbol('proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage', null, global);
      goog.exportSymbol('proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult', null, global);
       ...
       * @constructor
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage = function (opt_data) {
         jspb.Message.initialize(this, opt_data, 0, -1, null, null);
      };
      goog.inherits(proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage, jspb.Message);
      if (goog.DEBUG && !COMPILED) {
         proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.displayName = 'proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage';
      }
      ...
      if (jspb.Message.GENERATE_TO_OBJECT) {
          ...
          * @return {!Object}
          */
         proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.prototype.toObject = function (opt_includeInstance) {
            return proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.toObject(opt_includeInstance, this);
         };
          ...
          * @param {!proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage} msg The msg instance to transform.
          * @return {!Object}
          * @suppress {unusedLocalVariables} f is only used for nested messages
          */
         proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.toObject = function (includeInstance, msg) {
            var f, obj = {
               correlationid: jspb.Message.getFieldWithDefault(msg, 1, ""),
               status: jspb.Message.getFieldWithDefault(msg, 2, ""),
               transcriptresult: (f = msg.getTranscriptresult()) && proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.toObject(includeInstance, f),
               messageerrorcode: jspb.Message.getFieldWithDefault(msg, 4, "")
            };
       ...
       * @return {!proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage}
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.deserializeBinary = function (bytes) {
         var reader = new jspb.BinaryReader(bytes);
         var msg = new proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage;
         return proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.deserializeBinaryFromReader(msg, reader);
      };
       ...
       * @param {!proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage} msg The message object to deserialize into.
       * @param {!jspb.BinaryReader} reader The BinaryReader to use.
       * @return {!proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage}
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.deserializeBinaryFromReader = function (msg, reader) {
         while (reader.nextField()) {
            ...
            switch (field) {
               ...
               case 2:
                  ...
                  break;
               case 3:
                  var value = new proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult;
                  reader.readMessage(value, proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.deserializeBinaryFromReader);
                  msg.setTranscriptresult(value);
                  break;
               case 4:
                  var value = /** @type {string} */ (reader.readString());
                  msg.setMessageerrorcode(value);
                  break;
               default:
                  reader.skipField();
                  break;
       ...
       * @return {!Uint8Array}
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.prototype.serializeBinary = function () {
         var writer = new jspb.BinaryWriter();
         proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.serializeBinaryToWriter(this, writer);
       ...
       * @param {!proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage} message
       * @param {!jspb.BinaryWriter} writer
       * @suppress {unusedLocalVariables} f is only used for nested messages
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.serializeBinaryToWriter = function (message, writer) {
         var f = undefined;
         ...
         if (f != null) {
            writer.writeMessage(
               3,
               f,
               proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.serializeBinaryToWriter
            );
         }
         f = message.getMessageerrorcode();
         if (f.length > 0) {
            writer.writeString(
               4,
               f
       ...
       * @constructor
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult = function (opt_data) {
         jspb.Message.initialize(this, opt_data, 0, -1, null, null);
      };
      goog.inherits(proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult, jspb.Message);
      if (goog.DEBUG && !COMPILED) {
         proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.displayName = 'proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult';
      }
      ...
      if (jspb.Message.GENERATE_TO_OBJECT) {
          ...
          * @return {!Object}
          */
         proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.prototype.toObject = function (opt_includeInstance) {
            return proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.toObject(opt_includeInstance, this);
         };
          ...
          *     instance for transitional soy proto support:
          *     http://goto/soy-param-migration
          * @param {!proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult} msg The msg instance to transform.
          * @return {!Object}
          * @suppress {unusedLocalVariables} f is only used for nested messages
          */
         proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.toObject = function (includeInstance, msg) {
            var f, obj = {
               sourcelanguage: jspb.Message.getFieldWithDefault(msg, 1, ""),
               transcriptsMap: (f = msg.getTranscriptsMap()) ? f.toObject(includeInstance, undefined) : [],
               transcriptresultid: jspb.Message.getFieldWithDefault(msg, 3, ""),
               isadapted: jspb.Message.getFieldWithDefault(msg, 4, false),
               isfinal: jspb.Message.getFieldWithDefault(msg, 5, false),
               transcripterrorcode: jspb.Message.getFieldWithDefault(msg, 6, ""),
               ispongmessage: jspb.Message.getFieldWithDefault(msg, 7, false)
            };
       ...
       * Deserializes binary data (in protobuf wire format).
       * @param {jspb.ByteSource} bytes The bytes to deserialize.
       * @return {!proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult}
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.deserializeBinary = function (bytes) {
         var reader = new jspb.BinaryReader(bytes);
         var msg = new proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult;
         return proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.deserializeBinaryFromReader(msg, reader);
      };
       ...
       * Deserializes binary data (in protobuf wire format) from the
       * given reader into the given message object.
       * @param {!proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult} msg The message object to deserialize into.
       * @param {!jspb.BinaryReader} reader The BinaryReader to use.
       * @return {!proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult}
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.deserializeBinaryFromReader = function (msg, reader) {
         while (reader.nextField()) {
            if (reader.isEndGroup()) {
               break;
            }
            ...
            switch (field) {
               case 1:
                  ...
                  break;
               case 2:
                  var value = msg.getTranscriptsMap();
               ...
               case 3:
                  var value = /** @type {string} */ (reader.readString());
                  msg.setTranscriptresultid(value);
                  break;
               case 4:
                  var value = /** @type {boolean} */ (reader.readBool());
                  msg.setIsadapted(value);
                  break;
               case 5:
                  var value = /** @type {boolean} */ (reader.readBool());
               ...
               case 6:
                  var value = /** @type {string} */ (reader.readString());
                  msg.setTranscripterrorcode(value);
                  break;
               case 7:
                  var value = /** @type {boolean} */ (reader.readBool());
                  msg.setIspongmessage(value);
                  break;
               default:
                  reader.skipField();
                  break;
       ...
       * @return {!Uint8Array}
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.prototype.serializeBinary = function () {
         var writer = new jspb.BinaryWriter();
         proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.serializeBinaryToWriter(this, writer);
         return writer.getResultBuffer();
      };
       ...
       * Serializes the given message to binary data (in protobuf wire
       * format), writing to the given BinaryWriter.
       * @param {!proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult} message
       * @param {!jspb.BinaryWriter} writer
       * @suppress {unusedLocalVariables} f is only used for nested messages
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.serializeBinaryToWriter = function (message, writer) {
         var f = undefined;
         ...
         f = message.getTranscriptsMap(true);
         if (f && f.getLength() > 0) {
            f.serializeBinary(2, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeString);
         }
         f = message.getTranscriptresultid();
         if (f.length > 0) {
            writer.writeString(
               3,
               f
         ...
         f = message.getTranscripterrorcode();
         if (f.length > 0) {
            writer.writeString(
               6,
               f
      ...
      /**
       * optional string sourceLanguage = 1;
       * @return {string}
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.prototype.getSourcelanguage = function () {
         return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
      };


      /** @param {string} value */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.prototype.setSourcelanguage = function (value) {
         jspb.Message.setProto3StringField(this, 1, value);
      };


      /**
       * map<string, string> transcripts = 2;
       * @param {boolean=} opt_noLazyCreate Do not create the map if
       * empty, instead returning `undefined`
       * @return {!jspb.Map<string,string>}
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.prototype.getTranscriptsMap = function (opt_noLazyCreate) {
      ...
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.prototype.clearTranscriptsMap = function () {
         this.getTranscriptsMap().clear();
      };


      /**
       * optional string transcriptResultId = 3;
       * @return {string}
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.prototype.getTranscriptresultid = function () {
         return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
      };


      /** @param {string} value */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.prototype.setTranscriptresultid = function (value) {
         jspb.Message.setProto3StringField(this, 3, value);
      };


      /**
       * optional bool isAdapted = 4;
       * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
       * You should avoid comparisons like {@code val === true/false} in those cases.
       * @return {boolean}
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.prototype.getIsadapted = function () {
         return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 4, false));
      };


      /** @param {boolean} value */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.prototype.setIsadapted = function (value) {
         jspb.Message.setProto3BooleanField(this, 4, value);
      };


      /**
       * optional bool isFinal = 5;
       * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
       * You should avoid comparisons like {@code val === true/false} in those cases.
       * @return {boolean}
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.prototype.getIsfinal = function () {
         return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 5, false));
      };


      /** @param {boolean} value */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.prototype.setIsfinal = function (value) {
         jspb.Message.setProto3BooleanField(this, 5, value);
      };


      /**
       * optional string transcriptErrorCode = 6;
       * @return {string}
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.prototype.getTranscripterrorcode = function () {
         return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 6, ""));
      };


      /** @param {string} value */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.prototype.setTranscripterrorcode = function (value) {
         jspb.Message.setProto3StringField(this, 6, value);
      };


      /**
       * optional bool isPongMessage = 7;
       * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
       * You should avoid comparisons like {@code val === true/false} in those cases.
       * @return {boolean}
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.prototype.getIspongmessage = function () {
         return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 7, false));
      };


      /** @param {boolean} value */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult.prototype.setIspongmessage = function (value) {
       ...
       * @return {string}
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.prototype.getCorrelationid = function () {
         return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
      };


      /** @param {string} value */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.prototype.setCorrelationid = function (value) {
         jspb.Message.setProto3StringField(this, 1, value);
      };
       ...
       * @return {string}
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.prototype.getStatus = function () {
         return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
      };


      /** @param {string} value */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.prototype.setStatus = function (value) {
         jspb.Message.setProto3StringField(this, 2, value);
      };


      /**
       * optional TranscriptResult transcriptResult = 3;
       * @return {?proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult}
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.prototype.getTranscriptresult = function () {
         return /** @type{?proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult} */ (
            jspb.Message.getWrapperField(this, proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult, 3));
      };


      /** @param {?proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.TranscriptResult|undefined} value */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.prototype.setTranscriptresult = function (value) {
         jspb.Message.setWrapperField(this, 3, value);
      };


      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.prototype.clearTranscriptresult = function () {
       ...
       * @return {!boolean}
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.prototype.hasTranscriptresult = function () {
         return jspb.Message.getField(this, 3) != null;
      };


      /**
       * optional string messageErrorCode = 4;
       * @return {string}
       */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.prototype.getMessageerrorcode = function () {
         return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
      };


      /** @param {string} value */
      proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf.SpeechResultMessage.prototype.setMessageerrorcode = function (value) {
         jspb.Message.setProto3StringField(this, 4, value);
      };


      goog.object.extend(exports, proto.Microsoft.PowerPoint.SpeechFrontDoor.ProtoBuf);
